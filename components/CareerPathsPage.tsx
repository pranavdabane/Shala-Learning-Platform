    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-12 pb-20">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div className="space-y-2">
          ...
          <h1 className="text-4xl font-black tracking-tight leading-none lg:text-5xl text-white">Career Paths</h1>
          ...
          return (
            <div 
              ...
              className={`group relative p-6 md:p-8 rounded-[32px] cursor-pointer transition-all duration-500 border-2 ${
                isActive 
                  ? 'bg-background-main text-white border-primary shadow-[0_0_30px_rgba(230,255,0,0.2)]' 
                  : 'bg-card border-neon-border hover:border-primary/40'
              }`}
            >
              {match > 0 && (
                <div className="absolute top-4 right-4 bg-primary text-black text-[10px] font-black px-2 py-1 rounded-lg shadow-[0_0_10px_rgba(230,255,0,0.4)]">
                  {match}% MATCH
                </div>
              )}
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-white">{path.role}</span>
              </div>
            </div>
          );
        })}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16">
            <div className="space-y-8">
              <div className="text-left">
                <h4 className="text-xl md:text-2xl font-black mb-4 flex items-center gap-3 text-white">
              ...
              <div className="text-left">
                <h4 className="text-base md:text-lg font-black mb-4 text-white">Core Competencies</h4>
            ...
            <div className="space-y-6 text-left">
              <h4 className="text-lg md:text-xl font-black text-white">Path Curriculum</h4>
              <div className="space-y-4">
                {selectedPath.courseIds.map((id, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="size-10 flex items-center justify-center bg-primary text-black rounded-xl text-xs font-black shrink-0 shadow-[0_0_10px_rgba(230,255,0,0.2)]">
                        {index + 1}
                      </div>
                      <div className="flex-1">
                        <h5 className="font-bold text-sm leading-tight text-white group-hover:text-primary transition-colors">{course.title}</h5>
              ...
              <button 
                ...
                className="w-full py-4 bg-primary text-black font-black rounded-2xl hover:scale-105 transition-all shadow-[0_0_20px_rgba(230,255,0,0.4)] uppercase tracking-widest text-sm"
              >
                START YOUR JOURNEY
              </button>
            </div>
